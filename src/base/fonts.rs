const _ZH_CHARS: &str = "欢迎光临祝你一路顺风车位已满年月日时分秒剩余个！0123456789";
const _ZH_FONTS_BITMAP: [&[u8]; 34] = [
    &[
...
// 获取中文字体字模
pub fn get_zh_font(c: char) -> Result<&'static [u8], &'static str> {
...
pub fn get_zh_font_13x13(c: char) -> Result<&'static [u8], &'static str> {
    let bytes: &[u8] = match c {
        ...
        '年' => &[
            0x00, 0x10, 0x08, 0xE4, 0x26, 0x24, 0x24, 0xFC, 0x24, 0x24, 0x24, 0x04, 0x00, 0x01,
            0x01, 0x01, 0x01, 0x01, 0x01, 0x0F, 0x01, 0x01, 0x01, 0x01,
        ],
        '月' => &[
            0x00, 0x00, 0x00, 0xFE, 0x92, 0x92, 0x92, 0x92, 0x92, 0xFE, 0x00, 0x00, 0x00, 0x08,
            0x06, 0x01, 0x00, 0x00, 0x00, 0x00, 0x08, 0x07, 0x00, 0x00,
        ],
        '日' => &[
            0x00, 0x00, 0xFC, 0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0xFC, 0x00, 0x00, 0x00,
            0x07, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x07, 0x00,
        ],
        '时' => &[
            0x00, 0xFC, 0x24, 0x24, 0xFC, 0x00, 0x00, 0xD0, 0x10, 0x10, 0xFE, 0x00, 0x00, 0x07,
            0x02, 0x02, 0x07, 0x00, 0x00, 0x00, 0x08, 0x04, 0x03, 0x00,
        ],
        '分' => &[
            0x00, 0x20, 0x10, 0x28, 0x26, 0xE0, 0x20, 0x22, 0x2C, 0xF0, 0x20, 0x20, 0x00, 0x00,
            0x08, 0x04, 0x03, 0x00, 0x04, 0x04, 0x04, 0x03, 0x00, 0x00,
        ],
        '秒' => &[
            0x00, 0x10, 0xD2, 0xFC, 0x52, 0x92, 0x60, 0x18, 0x7E, 0x00, 0x88, 0x10, 0x00, 0x01,
            0x00, 0x0F, 0x00, 0x00, 0x08, 0x04, 0x04, 0x02, 0x01, 0x00,
        ],
        '停' => &[
            0x00, 0x20, 0xF8, 0x06, 0xC4, 0x7C, 0x6C, 0x6E, 0x6E, 0x6C, 0x7C, 0x44, 0x00, 0x00,
            0x0F, 0x00, 0x00, 0x01, 0x01, 0x09, 0x0F, 0x01, 0x01, 0x00,
        ],
        '车' => &[
            0x00, 0x00, 0x04, 0x64, 0x58, 0x46, 0xF4, 0x44, 0x44, 0x44, 0x44, 0x00, 0x00, 0x00,
            0x01, 0x01, 0x01, 0x01, 0x0F, 0x01, 0x01, 0x01, 0x01, 0x00,
        ],
        '元' => &[
            0x00, 0x00, 0x20, 0x24, 0xA4, 0x64, 0x24, 0xE4, 0x24, 0x24, 0x20, 0x00, 0x00, 0x08,
            0x04, 0x02, 0x01, 0x00, 0x00, 0x07, 0x04, 0x04, 0x04, 0x06,
        ],
        '0' => &[
